##just a mini module for my Node server using React.js [![Build Status](https://travis-ci.org/houd1ni/A-little-currency-magic--test.svg?branch=master)](https://travis-ci.org/houd1ni/A-little-currency-magic--test)(W)
